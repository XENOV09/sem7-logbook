    ...
    <div class="menu-sidebar__content js-scrollbar1">
        <nav class="navbar-sidebar">
            <ul class="list-unstyled navbar__list">
                ...
                <!-- Menu Utama -->
                <li class="has-sub <?= (basename($_SERVER['PHP_SELF']) == 'logbook.php') ? 'active show' : '' ?>">
                    <a class="js-arrow" href="#">
                        <i class="fas fa-book"></i>Menu Utama
                    </a>
                    <ul class="list-unstyled navbar__sub-list js-sub-list" <?= (basename($_SERVER['PHP_SELF']) == 'logbook.php') ? 'style="display:block;"' : '' ?>>
                        <li class="<?= (basename($_SERVER['PHP_SELF']) == 'logbook.php') ? 'active' : '' ?>">
